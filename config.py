...
## DEEP FAKES MISSING FROM LIST
## "Online gaming platform scams",     ## online gaming platform scams, betting apps scams like dream 11, teen patti, pokerbaazi etc
## "Cyber Extortion",
###############



#### ASK MANOHAR SIR FOR CATEGORIZATION OF WHEN SOCIAL MEDIA APPS ARE INVOLVED IN OPERATION OF SCAMS, LIKE TELEGRAM MOST POPULAR.
#### Facebook online marketplace scams etc.
#### WILL GET A LOT OF INSIGHTFUL DATA HERE.  -------- "Social media platform in op"
...
################################################################################ fake social media trading is under investment fraud but for querying diff due to many hits. 
    ...
    "vishing": [
        ...
        "call centre scam", "fake call centre scam",
    ],
